...
intents = json.loads(open('Computing_requirements.json').read())
...
# Create Chat window
ChatLog(base, bd=0, bg="white", height="8", width="50",
        font="Arial", )

ChatLog.config(state=DISABLED)

# Blind scrollbar to Chat window
...
EntryBox(base, bd=0, bg="white", width="29", height="5",
         font="Arial")
